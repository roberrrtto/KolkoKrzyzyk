...
class BoardPanel extends JPanel {
	...
	private ImageIcon iconX = new ImageIcon("src/krzyzyk-Ver2 copy.png");
	private ImageIcon iconWinnerX = new ImageIcon("src/krzyzyk-Winner-Ver2 copy.png");
	private ImageIcon iconO = new ImageIcon("src/kolko-Ver2 copy.png");
	private ImageIcon iconWinnerO = new ImageIcon("src/kolko-Winner-Ver2 copy.png");
	private ImageIcon iconH = new ImageIcon("src/kreska-pionowa-Ver2 copy 3.png");
	private ImageIcon iconV = new ImageIcon("src/kreska-pionowa-Ver2 copy.png");
	private ImageIcon iconBackground = new ImageIcon("src/tlo-jasne.png");
	...
	private void isWinnerX() {
		try {
			...
			if (playerPanel.getScoreX() == 3) {
				winFrame.getWinPanel().setWinMessage("The winner is " + playerPanel.getPlayerX().getText()); // sprawdzenie czy osiągnięto wynik 3, jesli tak to odkrycie winFrame
	...
	private void isWinnerO() {
		...
		if (playerPanel.getScoreO() == 3) { // sprawdzenie czy osiągnięto wynik 3, jesli tak to odkrycie winFrame
			winFrame.getWinPanel().setWinMessage("The winner is " + playerPanel.getPlayerO().getText());
			startJFrame.setVisible(false);
			gameFrame.setVisible(false);
			winFrame.setVisible(true);
			clearAllFields();
